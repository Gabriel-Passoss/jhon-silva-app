  ...
  return (
    <Flex flexDirection="row" mt="20px" bg="#242424" w="90%" h="150px">
      ...
      <Flex mt="25px" ml="20px" w="40%">
        <Text fontSize="lg" color="light.200">{name}</Text>
        <Text fontSize="sm" color="light.200" mt="5px">R${price}</Text>
        <Flex flexDirection="row" align="center">
          <HStack space={2}>
            <Button mt="15px" h="25px" w="25px" bg="light.200" onPress={() => setCounter(counter - 1)}>
              <Icon as={<AntDesign name="down" />} />
            </Button>
            <Text mt="15px" fontSize="md" color="light.200">{counter}</Text>
            <Button mt="15px" h="25px" w="25px" bg="light.200" onPress={() => setCounter(counter + 1)}>
